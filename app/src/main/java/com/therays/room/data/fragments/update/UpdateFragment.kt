package com.therays.room.data.fragments.update
...
class UpdateFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.updateSecondName.setText(args.currentUser.lastName)
    ...
    private fun updateItem() {
        ...
        val secondName = updateSecondName.text.toString()
        val age = Integer.parseInt(updateAge.text.toString())

        if (inputCheck(firstName, secondName, updateAge.text)) {
            ...
            Toast.makeText(requireContext(), "Couldn't update", Toast.LENGTH_LONG).show()
        }
    }
